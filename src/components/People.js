...
function People(props){
  ...
  const list={
    ...
    "Section Head" : [,"Azwar","Tiurma","Lisye","Valen","Hari","Dinovita","Kamari","Lena","Daniel"],
    "Supervisor":["Jelita","Marina","Trissa","Nadhira","Soedono","Noviza","Rendhi","Andrees","Valen T"],
  ...
  const listJob={
    ...
    "Yusron":"Logistics Dept Head",
    "Saly":"Marketing Dept Head",
    "Kamari":"Quality Control Section Head",
    "Azwar":"MS Section Head Finance Controller",
    ...
    "Nadhira":"Domestics Supervisor",
    "Marina":"Shipment Scheduler Supervisor",
    ...
    "Rendhi":"Logistics Supervisor",
    "Lena":"Logistics Section Head",
    "Andrees":"Logistics Supervisor",
